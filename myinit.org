...
(setq org-todo-keyword
  '((sequence "TODO" "IN-PROGRESS" "WAITING" "|" "DONE" "CANCLED")))
...
(define-key global-map (kbd "C-c t p") 'air-pop-to-org-agenda)

(setq org-capture-templates '(("a" "My TODO task format." entry
  (file "todo.org")
  "* TODO %?
SCHEDULED: %t")))
...
(define-key global-map (kbd "C-c t c") 'air-org-task-capture)
